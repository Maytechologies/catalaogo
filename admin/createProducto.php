...
exit;  */  
  ...
  /*   echo "<pre>";
    ...
    //SENTENCIA SQL PARA INSERTAR DATOS A LA DB
     ...
     $query = "INSERT INTO productos ( nombre, precio, ingredientes, tipo_id, modal_img_id, creado, small_img, estado_id)
     VALUE ( '$nombre', '$precio', '$ingredientes', '$tipo_id', '$modal_img_id', '$creado', '$nombreImagen', $estado_id )";
