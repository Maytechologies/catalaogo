...
$SQLconsul = " SELECT *FROM modal_producto WHERE estado = 2";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($id) {
        ...
        if ($resultado) {
            header('location: showUModal.php?registro=3');
                ...
                <div class="card">
                    <div class="card-header ">
                        <div class="row align-items-center d-flex justify-content-between">
                            <div class="col-6">
                                <h3 class="titulo card-title font-weight-bold mx-2">MODALES</h3> <span class="text-danger">INACTIVOS</span>
                                  </div>
                          
                                     <div class="col-6 d-flex justify-content-between align-items-center">
                                   <div class="nuevo">Nuevo Registro :</div>
                                <div class="col"><button class="btn btn-success" data-toggle="modal" data-target="#nuevoregistro"><i class="fas fa-plus-circle"></i></button>
                            </div>
                        </div>   
                        </div>           
                       <!--  </div>       
