        ...
        <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                     <div class="modal-header bg-success">
                        <h5 class="modal-title mx-auto" id="exampleModalLabel">REGISTRO DE PROMOCION</h5>
                    </div>
                        <div class="modal-body">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="nombre">Nombre :</label>
                                                    ...
                                                    <input type="text" class="form-control" name="name" placeholder="Nombre de la Promoción" required="">                                
                                            </div> 
                                        </div>
                                        <div class="col-12">
                                            <div class="form-group">
                         ...
                         <div class="row">
                             <div class="form-group">
                             <label for="logo_data">Flyer de la Promoción:</label>
